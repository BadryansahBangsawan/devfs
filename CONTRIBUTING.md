...
Thanks for improving DevFS.

End users install with `brew tap BadryansahBangsawan/mac-menu-apps` and `brew install --cask devfs`. This file is for source contributors.
